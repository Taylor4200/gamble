...
const LiveCasinoPage = () => {
    ...
    const fetchLiveCasinoGames = async () => {
        try {
            console.log('Fetching live casino games...');
            ...
            console.log('All games fetched:', gamesData);
            
            // Filter for live casino games
            const liveCasinoGames = gamesData.filter(game => {
                console.log('Checking game:', game.title, 'Type:', game.gameType);
                return game.gameType === 'LIVE CASINO';
            });
            console.log('Filtered live casino games:', liveCasinoGames);
            
            setGames(liveCasinoGames);
        } catch (error) {
        ...
        <div className="p-6">
            ...
            {loading ? (
                ...
                <div className="text-center text-gray-400 py-12">
                    <p>No live casino games found.</p>
